...
app.post("/api/insert", (req, res) => {
    ...
    const num_turns = req.body.num_turns;
    ...
    db.query(sql_insert_user, [username, score,  powerups_used, num_turns, time_in_game , datetimestamp], (err,result) => {
        res.send(result);
    })
});
